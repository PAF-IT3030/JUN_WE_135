...
// status images
const horizontalStatusImg1 = require("../assets/horizontal_post_img_1.jpg");
const horizontalStatusImg2 = require("../assets/horizontal_post_img_2.jpg");
const horizontalStatusImg3 = require("../assets/horizontal_post_img_3.jpg");
const verticalStatusImg1 = require("../assets/vertical_post_img_1.jpg");
...
const statuses = [
  {
    ...
    content:
      "lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt mollit anim id est laborum",
    images: [horizontalStatusImg1, horizontalStatusImg2, verticalStatusImg1],
    likeCount: 0,
    commentCount: 0,
    comments: ["comment 1", "comment 2", "comment 3"],
  },
...
export { images, names, posts, statuses };
